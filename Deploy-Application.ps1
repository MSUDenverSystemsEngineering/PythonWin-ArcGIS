...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'PythonWin'
	[string]$appVersion = '2.7'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'pythonwin' -CheckDiskSpace -PersistPrompt
		...
		If (Test-Path -Path "C:\Python27\ArcGIS10.7") { Execute-Process -Path "C:\Python27\ArcGIS10.7\python.exe" -Parameters "C:\Python27\ArcGIS10.7\Lib\site-packages\pywin32_postinstall.py -quiet -install"
		}
